...
{
public:
    using ReadinessType = std::uint32_t; //!< Bitwise combination of readiness types
    ...
    enum : ReadinessType
    {
        Receive = 1 << 0, //!< Check if sockets are ready to be received from
        Send    = 1 << 1, //!< Check if sockets are ready to be sent to
    };
